...
use App\Filament\Resources\PostResource\Export\ExportPosts;
use App\Filament\Resources\PostResource\Import\ImportPosts;
...
class PostResource extends Resource
{
                    ...
                    ->schema([
                        ...
                        Forms\Components\Grid::make()
                            ->schema([
                                ...
                                Forms\Components\Section::make(trans('cms.content.posts.sections.meta.title'))
                                    ->visible(fn($record) => $record && !empty($record->meta_url))
                                    ->description(trans('cms.content.posts.sections.meta.description'))
                                    ->schema([
                                        Forms\Components\TextInput::make('github_starts')
                                            ->disabled()
                                            ->numeric()
                                            ->label(trans('cms.content.posts.sections.meta.columns.github_starts')),
                                        Forms\Components\TextInput::make('github_watchers')
                                            ->disabled()
                                            ->numeric()
                                            ->label(trans('cms.content.posts.sections.meta.columns.github_watchers')),
                                        Forms\Components\TextInput::make('github_forks')
                                            ->disabled()
                                            ->numeric()
                                            ->label(trans('cms.content.posts.sections.meta.columns.github_forks')),
                                        Forms\Components\TextInput::make('downloads_total')
                                            ->disabled()
                                            ->numeric()
                                            ->label(trans('cms.content.posts.sections.meta.columns.downloads_total')),
                                        Forms\Components\TextInput::make('downloads_monthly')
                                            ->disabled()
                                            ->numeric()
                                            ->label(trans('cms.content.posts.sections.meta.columns.downloads_monthly')),
                                        Forms\Components\TextInput::make('downloads_daily')
                                            ->disabled()
                                            ->numeric()
                                            ->label(trans('cms.content.posts.sections.meta.columns.downloads_daily')),
                                    ]),
                            ])
                            ->columnSpan([
                                'sm' => 1,
    ...
    public static function table(Table $table): Table
    {
        ...
        $importActions[] = Tables\Actions\ImportAction::make()->importer(ImportPosts::class);
        // }
        // if (filament('filament-cms')::$allowExport) {
        $importActions[] = Tables\Actions\ExportAction::make()->exporter(ExportPosts::class);
        // }
        $table = $table
